package fiqri.com.navigationdrawer;
...
import fiqri.com.navigationdrawer.fragment.HalamanFragment;
import fiqri.com.navigationdrawer.fragment.HomeFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    final String profileImgUrl =
            "https://image.freepik.com/free-icon/google-search_318-10950.jpg";

    DrawerLayout drawer;
    Toolbar toolbar;
    ActionBarDrawerToggle toggle;

    private static String STATE_TITLE = "state_title";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgProfile = navigationView.getHeaderView(0).findViewById(R.id.image_view);
